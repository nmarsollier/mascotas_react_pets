...
var deletePet = function deletePet(id) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios["delete"](environment.backendUrl + "/v1/pet/" + id)).then(function () {
...
var savePet = function savePet(payload) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios.post(environment.backendUrl + "/v1/pet/" + payload.id, payload)).then(function (res) {
...
var newPet = function newPet(payload) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios.post(environment.backendUrl + "/v1/pet", payload)).then(function (res) {
        return Promise.resolve(res.data);
      });
    }, function (err) {
      return Promise.reject(err);
...
var loadPet = function loadPet(id) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios.get(environment.backendUrl + "/v1/pet/" + id)).then(function (res) {
        return Promise.resolve(res.data);
      });
    }, function (err) {
      return Promise.reject(err);
...
var loadPets = function loadPets() {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios.get(environment.backendUrl + "/v1/pet")).then(function (res) {
        return Promise.resolve(res.data);
      });
    }, function (err) {
      return Promise.reject(err);
